  ...
  return (
    <div className='container mx-auto p-6'>
      ...
      <div className=" w-full relative ">
        ...
        <div className="relative shadow-xl dark:bg-gray-900 bg-white border border-gray-800  px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-col justify-end items-start">
          ...
          <form className='space-y-6 w-full dark:text-white text-black' onSubmit={handleSubmit}>
                <div className='space-y-2'>
                <Label>Title</Label>
                    <Input type='text' name='title'  placeholder='Enter title for article...'/>
                    {
                ...
                <select name="category" className='flex h-10 border text-base w-full dark:bg-[#111827] rounded-md' id="">
